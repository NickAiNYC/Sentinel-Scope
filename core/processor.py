...
"""
    ...
    def _prepare_base64(self, file_source: Any) -> tuple[str, Optional[str]]:
        """
        ...
        for attempt in range(self.max_retries):
            try:
                ...
                if hasattr(response, 'usage'):
                    ...
                    self.total_api_cost += tokens * self.DEEPSEEK_VISION_COST_PER_1K_TOKENS / 1000
    ...
    def run_audit(
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=self.max_workers) as executor:
            futures = {
                executor.submit(self._process_single_image, source, update_progress): source 
            ...
            for future in concurrent.futures.as_completed(futures):
                try:
                    ...
                    results.append(CaptureClassification(
