...
def format_bbl(borough: str, block: str, lot: str) -> str | None:
    """
...
def get_dob_office_info(borough: str) -> dict[str, str] | None:
    """
...
def encode_image_to_base64(image_source: str | bytes | object) -> str:
    """
    ...
    try:
        ...
        raise OSError(f"Failed to encode image: {e}") from e


def get_image_metadata(image_source: str | bytes | object) -> dict[str, object]:
    """
...
def validate_image_file(file_path: str, max_size_mb: int = 10) -> tuple[bool, str]:
    ...
    if path.suffix.lower() not in valid_extensions:
        return (
            False,
            f"Invalid format: {path.suffix} (allowed: {valid_extensions})",
        )
...
def estimate_construction_cost(
    sqft: float, building_type: str, borough: str = "MANHATTAN"
) -> dict[str, float]:
    """
    ...
    Examples:
        ...
        ...     10000, "RESIDENTIAL_HIGH_RISE", "BROOKLYN"
        ... )
        {
...
def estimate_remediation_cost(
    gap_count: int, risk_level: str, building_type: str = "RESIDENTIAL_HIGH_RISE"
) -> float:
    """
...
def validate_json_structure(
    data: str | dict, required_keys: list[str]
) -> tuple[bool, str]:
    """
...
def generate_report_filename(
    project_name: str, report_type: str = "compliance", extension: str = "pdf"
) -> str:
    """
