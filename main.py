...
import time
from core.auth import sign_in, sign_up, sign_out
from core.database import get_db_client, get_projects_for_user, create_project, save_audit
...
def dashboard_page():
    ...
    if st.session_state.get("sub_view") == "new_project":
        with st.form("new_project_form"):
            ...
            p_type = st.selectbox("Type", ["Commercial High-Rise", "Residential", "Industrial"])
...
def audit_page(project_id: str):
    ...
    uploaded_files = st.file_uploader("Upload Photos", type=['png', 'jpg'], accept_multiple_files=True)
